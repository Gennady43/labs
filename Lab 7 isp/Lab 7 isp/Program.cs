...
namespace Lab_7_isp
{
    class Program
    {
        public static int CheckInt()
        {
            ...
            {
                Console.Write("Неправильный ввод. Повторите ещё раз: ");
            }
            return a;
        }
        ...
        static void Main()
        {
            Console.Write("Введите рациональное число (x,x): ");
            string num1 = CheckDouble();
            RationalNumber RatNum1 = RationalNumber.GetNumberObjectFromString(num1);
            Console.WriteLine($"{RatNum1.ShowFull()}");

            Console.Write("Введите дробное число (x/y): ");
            string num2 = GetFraction();
